...
Nhập phần tử mảng. Tính min, max, trung bình, tổng. Không sử dụng STL.
...
Bài 2: Mảng 2D ⭐⭐
Nhân 2 ma trận n×n. Tính toán ma trận định nghĩa 3×3. Hiển thị đẹp.
...
Cài đặt thay đổi kích thước mảng tự động (như std::vectorđơn giản). Hỗ trợ push_back, pop_back, at(i).
